...
![GitHub release (including pre-releases)](https://img.shields.io/github/v/release/user/repo?include_prereleases)
![Codecov](https://codecov.io/gh/yourusername/yourrepo/branch/main/graph/badge.svg)
